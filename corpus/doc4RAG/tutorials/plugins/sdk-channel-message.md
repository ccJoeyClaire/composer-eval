...
::: tip 先看人话
这页是官方新增的设计/开发参考。普通使用者不需要从头读；如果你只是安装和配置 OpenClaw，先回到「零基础照着做」。开发者要改通道、插件或 QA 流程时，再按章节慢慢看。
:::
...
Use this page together with [Building channel plugins](/tutorials/plugins/sdk-channel-plugins).
